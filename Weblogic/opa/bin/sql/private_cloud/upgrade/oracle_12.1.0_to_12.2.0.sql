...
create or replace procedure opa_upgrade_analysis_scenario as
    column_exists exception;
...
CALL opa_add_column_if_not_exists('DATA_SERVICE', 'soap_action_pattern', 'VARCHAR2(255 CHAR)');

CALL opa_upgrade_analysis_scenario();
...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public, config_property_description)
	(SELECT 'analysis_schemaVersion', NULL, 0, 1, 'Version of the analysis server database schema' FROM DUAL 
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='analysis_schemaVersion'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public, config_property_description)
	(SELECT 'log_billingId', NULL, 0, 1, 'billing id sent to the ACS logging system when a loggable event occurs' FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_billingId'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public, config_property_description)
	(SELECT 'log_instanceId', NULL, 0, 1, 'instance id sent to the ACS logging system when a loggable event occurs'  FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_instanceId'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public, config_property_description)
	(SELECT 'log_trackingHost', NULL, 0, 1, 'tracking host sent to the ACS logging system when a loggable event occurs' FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_trackingHost'));
...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public)
	(SELECT 'log_enabled', 0, 1, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_enabled'));
...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public)
	(SELECT 'log_outputDirectory', NULL, 0, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_outputDirectory'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public)
	(SELECT 'log_outputRecordPerFile', 0, 1, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_outputRecordPerFile'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public)
	(SELECT 'log_outputRolloverInterval', 0, 1, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_outputRolloverInterval'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public)
	(SELECT 'log_productFamily', NULL, 0, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_productFamily'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public)
	(SELECT 'log_engagementRequestSecure', 0, 1, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_engagementRequestSecure'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public)
	(SELECT 'log_ipForwarderPropertyFile', NULL, 0, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_ipForwarderPropertyFile'));

INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_str_value, config_property_type, config_property_public)
	(SELECT 'log_ipForwarderPropertyKey', NULL, 0, 0 FROM DUAL
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='log_ipForwarderPropertyKey'));
...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public, config_property_description)
	(SELECT 'max_active_deployments', 0, 1, 1, 'The maximum number of active deployments (interview and web service). 0 = no limit' FROM DUAL 
		WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='max_active_deployments'));
...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public, config_property_description)
    (SELECT 'file_attach_max_mb_single', 10, 1, 1, 'Maximum allowed size in megabytes for a single attachment excluding generated forms' FROM DUAL
        WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='file_attach_max_mb_single'));
...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_int_value, config_property_type, config_property_public, config_property_description)
    (SELECT 'file_attach_max_mb_total', 50, 1, 1, 'Maximum allowed total size in megabytes for session attachments including generated forms' FROM DUAL
        WHERE NOT EXISTS (SELECT * FROM CONFIG_PROPERTY WHERE config_property_name='file_attach_max_mb_total'));
