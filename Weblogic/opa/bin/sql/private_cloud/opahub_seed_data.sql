...
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_public, config_property_description, config_property_type, config_property_str_value) VALUES ('hub_news_url', 1, 'url for hub news', 0, '../hub/news/news-{1}.html');
INSERT INTO CONFIG_PROPERTY (config_property_name, config_property_public, config_property_description, config_property_type, config_property_str_value) VALUES ('opa_help_url', 1, 'url for hub news', 0, 'https://documentation.custhelp.com/euf/assets/devdocs/{0}/PolicyAutomation/{1}/Default.htm');
...
INSERT INTO COLLECTION (collection_name, collection_status, collection_description) VALUES ('Default Collection', 0, 'The default collection');


INSERT INTO AUTHENTICATION (user_name, status, hub_admin, user_type, full_name) VALUES ('admin', 0, 1, 0, 'Default admin user');
...
INSERT INTO AUTHENTICATION (user_name, status, hub_admin, user_type, full_name) VALUES ('author', 1, 0, 0, 'Example project Author/Admin');
...
INSERT INTO AUTHENTICATION (user_name, status, hub_admin, user_type, full_name) VALUES ('apiuser', 1, 0, 1, 'Example Determinations/Web API user');
